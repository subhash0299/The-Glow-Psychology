  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Hero */}
        <div className="bg-gradient-to-br from-teal-500 to-cyan-500 text-white">
          <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white/90 max-w-3xl px-2">
              From hydrating to mild exfoliating toners, these picks help
              balance, soothe and prep your skin for the rest of your routine.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
                  ...
                  {toners.map((product, index) => (
                    ...
                    >
                      ...
                      <td className="py-2 sm:py-3 px-2 sm:px-4">
                        {product.bestFor && (
                          <span className="inline-block text-xs font-medium bg-teal-100 text-teal-700 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full whitespace-nowrap">
                            {product.bestFor}
                          </span>
                        )}
                      </td>
                      ...
                      <td className="py-2 sm:py-3 px-2 sm:px-4">
                        ...
                        className="inline-flex items-center gap-1 bg-rose-500 hover:bg-rose-600 text-white text-sm font-semibold px-3 py-1.5 rounded-lg transition-colors"
                      >
                        Buy
          ...
          {/* How to choose */}
          <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-4 sm:p-6 md:p-8 mb-8 sm:mb-12">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">
              How to Choose the Right Toner
            </h3>
            <div className="space-y-3 sm:space-y-4">
              <div className="flex gap-2 sm:gap-3">
                <div className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 bg-teal-500 text-white rounded-full flex items-center justify-center font-semibold text-sm sm:text-base">
                  1
                </div>
                <div>
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm">
                    Look for toners with green tea, PHA or mild BHA to control
              ...
              <div className="flex gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm">
                    Choose alcohol-free, fragrance-free formulas with soothing
                    ingredients like cica or white lotus.
                  </p>
                </div>
              </div>
              <div className="flex gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm">
                    Hydrating toners with glycerin, hyaluronic acid or
                    panthenol help to keep the skin plump and comfortable.
                  </p>
                </div>
              </div>
            </div>
