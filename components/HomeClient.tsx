  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50 to-white bg-mesh">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
        ...
        >
          <motion.div
            className="inline-flex items-center gap-2 bg-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full shadow-sm mb-4 sm:mb-6"
        ...
        >
          <div className="text-center mb-4 sm:mb-6 md:mb-8">
            <motion.h2 variants={item} className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-2 sm:mb-3 px-2">
              Product Categories
            </motion.h2>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 md:gap-6">
            ...
            >
              <motion.div whileHover={cardHover} transition={{ type: 'spring', stiffness: 400, damping: 25 }} className="h-full rounded-2xl shadow-lg hover:shadow-2xl transition-shadow">
            ...
            <motion.div variants={item}>
            <Link href="/best-vitamin-c-serum-india" className="group relative overflow-hidden rounded-2xl shadow-lg block">
              <motion.div whileHover={cardHover} transition={{ type: 'spring', stiffness: 400, damping: 25 }} className="h-full rounded-2xl shadow-lg hover:shadow-2xl transition-shadow">
            ...
            <motion.div variants={item}>
            <Link href="/best-face-cleanser-india" className="group relative overflow-hidden rounded-2xl shadow-lg block">
              <motion.div whileHover={cardHover} transition={{ type: 'spring', stiffness: 400, damping: 25 }} className="h-full rounded-2xl shadow-lg hover:shadow-2xl transition-shadow">
            ...
            <motion.div variants={item}>
            <Link href="/best-face-moisturizer-india" className="group relative overflow-hidden rounded-2xl shadow-lg block">
              <motion.div whileHover={cardHover} transition={{ type: 'spring', stiffness: 400, damping: 25 }} className="h-full rounded-2xl shadow-lg hover:shadow-2xl transition-shadow">
            ...
            <motion.div variants={item}>
            <Link href="/best-face-toner-india" className="group relative overflow-hidden rounded-2xl shadow-lg block">
              <motion.div whileHover={cardHover} transition={{ type: 'spring', stiffness: 400, damping: 25 }} className="h-full rounded-2xl shadow-lg hover:shadow-2xl transition-shadow">
            ...
            <motion.div variants={item}>
            <Link href="/best-eye-cream-india" className="group relative overflow-hidden rounded-2xl shadow-lg block">
              <motion.div whileHover={cardHover} transition={{ type: 'spring', stiffness: 400, damping: 25 }} className="h-full rounded-2xl shadow-lg hover:shadow-2xl transition-shadow">
            ...
            <motion.div variants={item}>
            <Link href="/best-exfoliator-india" className="group relative overflow-hidden rounded-2xl shadow-lg block">
              <motion.div whileHover={cardHover} transition={{ type: 'spring', stiffness: 400, damping: 25 }} className="h-full rounded-2xl shadow-lg hover:shadow-2xl transition-shadow">
            ...
            <motion.div variants={item}>
            <Link href="/best-face-oil-india" className="group relative overflow-hidden rounded-2xl shadow-lg block">
              <motion.div whileHover={cardHover} transition={{ type: 'spring', stiffness: 400, damping: 25 }} className="h-full rounded-2xl shadow-lg hover:shadow-2xl transition-shadow">
          ...
          {filteredProducts.length > 0 ? (
            ...
            >
              {filteredProducts.map((product, index) => (
                <motion.div key={`${product.name}-${index}`} variants={item}>
        ...
        <motion.div
          className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 mb-8 sm:mb-12"
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            <motion.div
              className="text-center p-4 sm:p-5 md:p-6 rounded-xl bg-rose-50"
        ...
        <motion.div
          className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-2xl p-8 mb-12 border-2 border-rose-100"
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: '-60px' }}
          transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}
