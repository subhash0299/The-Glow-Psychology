  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
        <SkinTypeFilter
          products={eyeCreams}
          title="Top Eye Cream Picks for Indian Skin"
          description="These eye creams are specially curated for Indian skin types, offering ingredients like caffeine, peptides, and retinol to target dark circles and puffiness."
        />
      </div>
    </div>
  )
